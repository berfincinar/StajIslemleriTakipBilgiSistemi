<%-- 
    Document   : ogretmenBilgi
    Created on : 29.Ara.2020, 20:45:35
    Author     : Hadise
--%>
...
<html>
   ...
   <title>SCÜ Staj Takip</title>
	<link href="css/ogretmenTasarim.css" type="text/css" rel="stylesheet"/>
  ...
  <!--ARAMA ÇUBUĞU-->
    ...
    <div id="bilgiBoard">
        ...
        <ul class="ustBanner">
            ...
            <li><a href="#"><center> Öğretmen Bilgi</center></a></li>   
        </ul>

         <ul class="ogretmenBilgileri">
            
            <li><a href="#"><center>İsim-Soyisim:</center></a></li>
